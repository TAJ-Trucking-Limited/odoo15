...
class AccountMove(models.Model):
    ...
    vat_percentage = fields.Float(
        string='VAT (%)',
        digits=(16, 4),
        help="VAT rate copied from the sales order when this invoice was "
             "generated by the VAT (%) feature.",
    )
    is_vat_percentage_invoice = fields.Boolean(
        string='VAT Percentage Invoice',
        default=False,
        help="Technical marker set only when the invoice is generated from a "
             "sales order managed by the VAT (%) feature. It selects the "
             "custom VAT totals on the invoice report. It stays False on "
             "existing, manual and legacy invoices.",
    )
